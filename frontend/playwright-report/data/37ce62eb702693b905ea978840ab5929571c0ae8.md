...
- Name: user-management\login.spec.js >> User Management - Login >> shows validation for empty login
- Location: tests\user-management\login.spec.js:5:3
      ...
      - generic [ref=e22]:
        ...
        - generic [ref=e26]:
          - generic [ref=e27]:
            ...
            - paragraph [ref=e29]: Email is required.
          - generic [ref=e30]:
            - text: Password
            - textbox "Password" [ref=e31]:
              - /placeholder: Enter password
            - paragraph [ref=e32]: Password is required.
          - button "Login" [active] [ref=e33]
